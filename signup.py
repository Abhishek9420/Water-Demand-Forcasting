...
class Ui_signUp(object):
    ...
    def setupUi(self, Dialog):
        ...
        Dialog.setStyleSheet(_fromUtf8("background-image: url(B.png); border: 2px solid orange"))
        ...
        self.label.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.label_2.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.label_M.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.label_3.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.email_lineEdit.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.mob_lineEdit.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.password_lineEdit.setStyleSheet("background-image: url(white.jpg);;border: 2px solid red")
        ...
        self.signup_btn.setStyleSheet("background-image: url(skyblue.jpg);;border: 2px solid red")
        ...
        self.exit.setStyleSheet("background-image: url(skyblue.jpg);;border: 2px solid red")
